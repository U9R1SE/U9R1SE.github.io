...
HTMLActuator.prototype.addTile = function(a) {
    ...
    2042 < a.value && f.push("tile-super");
...
HTMLActuator.prototype.scoreTweetButton = function() {
    ...
    a.setAttribute("data-url", "http://2042game.com");
    a.setAttribute("data-counturl", "http://2042game.com");
    a.textContent = "Tweet";
    a.setAttribute("data-text", "I scored " + this.score + " points at 2042, a game where you join numbers to score high! #2042game");
    return a
};
...
Grid.prototype.empty = function() {
    for (var a = [], b = 0; b < this.size; b++)
        for (var c = a[b] = [], d = 0; d < this.size; d++) c.push(null);
    return a
};
...
Grid.prototype.serialize = function() {
    for (var a = [], b = 0; b < this.size; b++)
        for (var c = a[b] = [], d = 0; d < this.size; d++) c.push(this.cells[b][d] ? this.cells[b][d].serialize() : null);
    return {
        size: this.size,
        cells: a
    }
